...
UStoreWidgetBase::FChangeStoreButtonEvent& UStoreWidgetBase::OnButtonClickedChangeStore()
{
	return ChangeStoreEvent;
}

FSlotEvent& UStoreWidgetBase::OnSlotHover()
{
	return SlotHoverEvent;
}

FSlotEvent& UStoreWidgetBase::OnSlotRButtonDown()
{
	return SlotRButtonDownEvent;
}

FSlotDragDropEvent& UStoreWidgetBase::OnSlotDragDrop()
{
